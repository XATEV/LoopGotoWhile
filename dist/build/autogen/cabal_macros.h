...
/* package loopgotowhile-0.1 */
#define VERSION_loopgotowhile "0.1"
#define MIN_VERSION_loopgotowhile(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "loopgotowhile-0.1-FZRHlz3QgyiDmpnRCFPvrz"

#define CURRENT_PACKAGE_KEY "loopgotowhile-0.1-FZRHlz3QgyiDmpnRCFPvrz"
